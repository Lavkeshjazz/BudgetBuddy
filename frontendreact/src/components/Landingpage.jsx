        ...
        <div className='landingcard1'>
         <p className='landingdetails'>
          <div className="icon-text-container">
            <img className="icons" src="/keybenefits.png" style={{ width: '55px', height: '55px', paddingTop: '5px', filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.5))' }} />
            <span className='highlight3'>Key Benefits :</span>
          </div>
          <div className="icon-text-container">
            <img className="icons" src="/notifications.png" style={{ width: '50px', height: '50px', paddingTop: '5px', filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.5))' }} />
          ...
          <div className="icon-text-container">
            <img className="icons" src="/trend.png" style={{ width: '55px', height: '70px', paddingTop: '5px', filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.5))' }} />
            <span><span className='highlight2'>Trend Analysis</span>: Access detailed insights on trending products and popular buys.</span>
          </div>
          <div className="icon-text-container">
            <img className="icons" src="/scales.png" style={{ width: '55px', height: '63px', paddingTop: '5px', filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.5))' }} />
            <span><span className='highlight2'>Comparison Tools</span>: Compare prices across multiple stores to find the best deals.</span>
          </div>
          <div className="icon-text-container">
            <img className="icons" src="/pricetrack.png" style={{ width: '55px', height: '55px', paddingTop: '5px', filter: 'drop-shadow(0 4px 8px rgba(0, 0, 0, 0.5))' }} />
